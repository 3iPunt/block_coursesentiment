...
namespace block_coursesentimentgateway_aws\local\service;

use core_sms\message_status;
use block_coursesentimentgateway_aws\helper;
use block_coursesentimentgateway_aws\local\aws_sms_service_provider;
use stdClass;
