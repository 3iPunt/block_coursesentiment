...
$string['numbermessages'] = 'Número mensajes enviados';
$string['numberteachermessages'] = 'Número mensajes enviados por el profesorado';
$string['numbermessagesnotanalyzed'] = 'Número mensajes no analizados, normalmente es porque no se detecta el idioma o el cuerpo del mensajes es muy corto';
$string['numberforums'] = 'Número foros analizados';
$string['numberdiscussions'] = 'Número debates analizados';
$string['messages'] = 'Mensajes';
$string['teachermessages'] = 'Mensajes profesorado';
$string['messagesnotanalyzed'] = 'Mensajes no analizados';
$string['forums'] = 'Foros';
...
$string['usernamedesc'] = 'El nombre que la IA usará internamente para referirse al usuario.';
