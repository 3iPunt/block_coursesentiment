...
$string['numbermessages'] = 'Messages analyzed number';
$string['numberteachermessages'] = 'Teacher analyzed messages number';
$string['numbermessagesnotanalyzed'] = 'Messages not analyzed number, usually happens because the language isn\'t detected or the message body is too short.';
$string['numberforums'] = 'Forum analyzed number';
$string['discussions'] = 'Discussion analyzed number';
$string['messages'] = 'Messages';
$string['teachermessages'] = 'Teacher messages';
$string['messagesnotanalyzed'] = 'Messages not analyzed';
